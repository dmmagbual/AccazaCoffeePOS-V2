...
export interface TrustedResolvedOptionSnapshot extends OptionSnapshot { taxSnapshot: TaxSnapshot }
export interface TrustedResolvedSaleLine { quantity: number; product: ProductSnapshot; category: CategorySnapshot; variation?: VariationSnapshot; unitPrice: number; recipe?: RecipeSnapshot; options: readonly TrustedResolvedOptionSnapshot[]; tax: TaxSnapshot; notes?: string }
