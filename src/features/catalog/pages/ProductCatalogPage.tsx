...
const areas = [
  { title: 'Product categories', description: 'Hierarchy, visibility, controlled ordering, and deactivation.', icon: Layers3, to: ROUTES.catalogCategories },
  { title: 'Products', description: 'Product master, POS visibility, recipe links, and branch availability.', icon: PackagePlus, to: ROUTES.catalogProducts },
  { title: 'Sizes & variations', description: 'Default variations, variation recipes, and variation prices.', icon: SlidersHorizontal, to: ROUTES.catalogVariations },
  { title: 'Modifiers & add-ons', description: 'Structured recipe effects, price adjustments, and selection rules.', icon: Tags, to: ROUTES.catalogOptionGroups },
