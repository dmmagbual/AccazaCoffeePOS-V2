...
const draft: BusinessSetupDraft = { idempotencyKey: 'setup_00000001', step: 13, status: 'in_progress', profile: { legalName: 'Accaza Coffee House', tradeName: 'Accaza', businessType: 'coffee_shop', logoUrl: '', address: 'Main Street', country: 'Philippines', province: 'Metro Manila', city: 'Manila', postalCode: '1000', timezone: 'Asia/Manila', currency: 'PHP', language: 'en', fiscalYearStartMonth: 1, businessDays: ['Mon', 'Tue'] }, organizationName: 'Accaza Coffee House', branch: { code: 'MAIN', name: 'Main Branch', address: 'Main Street', openingHours: '08:00-20:00', managerName: 'Owner', timezone: 'Asia/Manila', currency: 'PHP' }, tax: { name: 'Configured tax', rate: '0.075', mode: 'exclusive' }, chartTemplate: 'coffee_shop', enabledFeatures: ['FINANCE.ENABLED', 'INVENTORY.SIMPLE_STORAGE'], owner: { name: 'Owner', email: 'owner@example.com', password: 'secure-password' }, updatedAt: '2026-08-01T00:00:00.000Z' }
