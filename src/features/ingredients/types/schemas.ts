...
const ingredientInputBaseSchema = z.object({
...
export const ingredientInputSchema = ingredientInputBaseSchema.superRefine((value, context) => {
...
export const ingredientUpdateSchema = ingredientInputBaseSchema.partial().omit({ organizationId: true })
