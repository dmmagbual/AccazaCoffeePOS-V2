...
const order = { id: 'o', orderNumber: 'O-1', status: 'completed', organizationId: 'org', storeId: 'branch', cashierId: 'u', items: [], payments: [] as Payment[], subtotal: 100, discount: 10, tax: 5, total: 95, estimatedCogs: 0, saleTimestamp: now } satisfies CompletedSaleOrder
