...
`functions/tests/loyalty-redemption.test.mjs` additionally proves persisted redemption amount/points in immutable sale and receipt evidence, with stable replay. A live-master-data mutation case specifically for a redeemed sale remains hardening work.
